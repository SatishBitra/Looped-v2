...
function Sidebar() {
  ...
  return (
    <aside
      ...
      className="hidden md:flex fixed top-4 bottom-4 w-[72px] z-30 flex flex-col items-center py-5 bg-card border border-border rounded-[32px] shadow-[var(--shadow-soft)]"
    >
      <Link
        to="/home"
      ...
      <div className="flex flex-col gap-2 items-center">
        ...
        >
          ...
          <span className="pointer-events-none absolute left-full ml-3 px-2.5 py-1 rounded-lg bg-foreground text-background text-[12px] font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity z-50">
            Messenger
          </span>
        </Link>
        <button
          ...
          className="group relative w-11 h-11 rounded-full grid place-items-center bg-[#F4F4F7] dark:bg-[#242428] text-muted-foreground hover:bg-destructive/15 hover:text-destructive transition-colors cursor-pointer"
          title="Sign Out"
        >
            ...
            <AnimatePresence>
              {isProfilePopoverOpen && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: 10, scale: 0.95 }}
                  transition={{ duration: 0.15 }}
                  className="absolute right-0 top-12 w-[320px] max-h-[calc(100vh-80px)] overflow-y-auto bg-gradient-to-b from-white/95 via-white/90 to-white/80 dark:from-[#1c1c1f]/95 dark:via-[#1c1c1f]/90 dark:to-[#18181b]/80 backdrop-blur-[24px] border border-white/20 dark:border-white/10 rounded-2xl shadow-2xl z-50 text-left"
                >
                  {/* Portrait Card Image */}
                  ...
                  <div className="p-5 pt-4 pb-6 text-left">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-semibold text-destructive bg-destructive/10 hover:bg-destructive/20 transition-colors cursor-pointer"
                    ...
                    <div className="pt-3 mt-3 border-t border-border/50">
                      <button
                        ...
                        className="flex items-center justify-center gap-2 w-full py-2.5 px-3 rounded-xl text-xs font-semibold text-white bg-destructive hover:bg-destructive/90 transition-all shadow-sm active:scale-[0.99] cursor-pointer"
                      >
...
export function AppShell({
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        {isMobileMenuOpen && (
          <>
            ...
            >
              ...
              {/* Bottom Messenger Link & Sign Out / Footer */}
              <div className="pt-4 border-t border-border mt-auto flex flex-col gap-3">
                ...
                >
                  <div className="flex items-center gap-3.5">
                    ...
                    <span className="text-[14px]">Messenger</span>
                  </div>
                </Link>
                <button
                  type="button"
                  ...
                  className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl text-xs font-semibold text-white bg-destructive hover:bg-destructive/90 transition-all cursor-pointer shadow-sm active:scale-[0.99]"
                >
      ...
      <main className="pl-4 pr-4 md:pl-[104px] md:pr-6 py-6 max-w-[1440px] mx-auto w-full">
        {!hideTopNav && (
          <TopNav
